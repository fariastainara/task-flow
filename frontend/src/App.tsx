                      ...
                      <Box sx={{ flex: 1, minWidth: 200 }}>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {tasks.length} {tasks.length === 1 ? "tarefa" : "tarefas"} • {pct}%
                          </Typography>
                        </Box>
                        <Box
                          sx={{
                        ...
                        >
                          {done > 0 && <Box sx={{ width: seg(done), bgcolor: "#12B76A", transition: "width 0.4s" }} />}
                          {inProgress > 0 && <Box sx={{ width: seg(inProgress), bgcolor: "#039BE5", transition: "width 0.4s" }} />}
                          {overdue > 0 && <Box sx={{ width: seg(overdue), bgcolor: "#F04438", transition: "width 0.4s" }} />}
                        </Box>
                        <Box sx={{ display: "flex", gap: 1.5, mt: 0.75, flexWrap: "wrap" }}>
                          {[
                            { label: "Concluídas", count: done, color: "#12B76A" },
                            { label: "Em andamento", count: inProgress, color: "#039BE5" },
                            { label: "Atrasadas", count: overdue, color: "#F04438" },
                            { label: "A fazer", count: todo, color: "#9e9e9e" },
